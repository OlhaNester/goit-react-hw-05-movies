...
const getMovieByTitle = async (query, page) => {
    const response = await Axios.get(`https://api.themoviedb.org/3/search/movie?api_key=ee059677e8bdbcfa281a4ce6304abcdd&language=en-US&query=${query}&page=${page}&include_adult=false`)
...
export const MoviesPage = () => {
    ...
    return (
        <>
            ...
            <button type="button" onClick={()=>fetchMovie() }>more</button>
